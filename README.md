...
|---|---|---|---|---|
| **Kathbath** | Read-speech corpus, crowd-sourced via Karya platform | 12 Indian languages |[https://indicwhisper.objectstore.e2enetworks.net/vistaar_benchmarks/kathbath.zip](link) |Released by AI4Bharat; ~1,700 hrs total across languages, recorded by native speakers reading local news/Wikipedia-style text. Has a **Noisy 8kHz** variant (telephone-quality) used by some commercial APIs (e.g. Gnani), which is *not* directly comparable to clean 16kHz evaluation — a key caveat in this benchmark. |
| **IndicVoices** | Natural, spontaneous conversational speech corpus | [https://huggingface.co/datasets/ai4bharat/IndicVoices](link) |22+ Indian languages, incl. low-resource NE India varieties | Released by AI4Bharat; captures diverse real-world speaking styles, dialects, and code-mixing, harder and more realistic than read-speech corpora like Kathbath, useful for stress-testing generalization beyond scripted audio. |
